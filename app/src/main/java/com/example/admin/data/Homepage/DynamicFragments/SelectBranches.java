...
public class SelectBranches extends AppCompatActivity {
    ...
    void getData(){
        ...
        try {
            ...
            call = apiService.getExam(details.getString("dbname",""),details.getString("branches",""),API_KEY);

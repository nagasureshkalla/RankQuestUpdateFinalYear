...
public class Fragment_Reportingcenters_Ecet extends Fragment {
    RecyclerView r;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=inflater.inflate(R.layout.fragment_fragment__reportingcenters__ecet, container, false);
    ...
    public void start(View view){
        try {
            ...
            Call<List<ReportingCenters>> call = apiService.getCenter(details.getString("dbname",""),details.getString("reportingcenters",""),API_KEY);

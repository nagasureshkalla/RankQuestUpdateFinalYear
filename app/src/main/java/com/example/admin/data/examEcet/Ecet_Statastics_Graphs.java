...
public class Ecet_Statastics_Graphs extends AppCompatActivity {
    ...
    List<BranchStatatics> list;
        ...
        TextView t,total;
        String code;
        ApiInterfacePut apiService,apiService1;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_ecet__statastics__graphs);
            ...
            try {
                apiService = ApiClientExams.getClient().create(ApiInterfacePut.class);
                String q = "{code:'" + code + "'}";
                call = apiService.getBranchStatastics(details.getString("dbname",""),details.getString("branchstatistics",""),API_KEY,q);
